function r= Draw_7DOF_FB7roll_point_dual(P_R,RotationM_R,PathPoint_R,P_L,RotationM_L,PathPoint_L)
...
%% ========End effector======== %%
%Right Arm
plot3(P_R(10,1),P_R(10,2),P_R(10,3),'go','MarkerSize',10,'Linewidth',4);text(P_R(10,1),P_R(10,2),P_R(10,3),'R_End');
%Left Arm
...
plot3([P_R(10,1),P_R(10,1)+V_H_hat_x(1,1)],[P_R(10,2),P_R(10,2)+V_H_hat_x(2,1)],[P_R(10,3),P_R(10,3)+V_H_hat_x(3,1)],'-m','LineWidth',2); text(P_R(10,1)+V_H_hat_x(1,1),P_R(10,2)+V_H_hat_x(2,1),P_R(10,3)+V_H_hat_x(3,1),'X')
plot3([P_R(10,1),P_R(10,1)+V_H_hat_y(1,1)],[P_R(10,2),P_R(10,2)+V_H_hat_y(2,1)],[P_R(10,3),P_R(10,3)+V_H_hat_y(3,1)],'-g','LineWidth',2); text(P_R(10,1)+V_H_hat_y(1,1),P_R(10,2)+V_H_hat_y(2,1),P_R(10,3)+V_H_hat_y(3,1),'Y')
