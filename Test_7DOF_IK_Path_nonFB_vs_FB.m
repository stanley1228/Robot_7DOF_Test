...
for t=1:1:DEF_DESCRETE_POINT
    ...
    [out_x_end_L,out_y_end_L,out_z_end_L,out_alpha_L,out_beta_L,out_gamma_L,P_L,RotationM_L] = FK_7DOF_FB(L0n,L1n,L2n,L3n,L4n,L5n,x_base_L,y_base_L,z_base_L,theta_L);
    ...
    %畫關節點圖
    Draw_7DOF_nonFB_vs_FB_point(P_R,RotationM_R,PathPoint_R,P_L,RotationM_L,PathPoint_L,Vn_u_f,V_rf_l4,Vn_rfl4_nuf,Vproj_end_rfl4_nuf,Vn_nuf_rotx6_along_NRfl4Nuf,Vn_WstToEnd_WstToProjEndRfl4Nuf,V_n_yrot12);
