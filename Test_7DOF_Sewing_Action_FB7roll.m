...
%右手圓周路徑
ini_rotate_p_R=[-90 -90 0]+TranFrameToRobot;%從架子坐標系轉到手臂座標系
...
%左手圓周路徑
ini_rotate_p_L=[90 90 0]+TranFrameToRobot;
...
for abst=0:DEF_CYCLE_TIME:TotalTime
    ...
    elseif abst<=Seqt(S_R_FCIRX_L_BCIRX)%右手旋轉往正X 左手旋轉往負X
        ...
        PathPlanPoint_R=[Needle_RobotF 0 0 0 0] +rR*[cos(0.5*pi*t/Itv+ini_rad_R) sin(0.5*pi*t/Itv+ini_rad_R) 0 0 0 0 0]+[0 0 0 R_p(S_R_FCIRX_L_BCIRX-1,4:7)+(R_p(S_R_FCIRX_L_BCIRX,4:7)-R_p(S_R_FCIRX_L_BCIRX-1,4:7))*t/Itv]; %右手上到下弧形
        PathPlanPoint_L=[Needle_RobotF 0 0 0 0] +rL*[cos(0.5*pi*t/Itv+ini_rad_L) sin(0.5*pi*t/Itv+ini_rad_L) 0 0 0 0 0]+[0 0 0 L_p(S_R_FCIRX_L_BCIRX-1,4:7)+(L_p(S_R_FCIRX_L_BCIRX,4:7)-L_p(S_R_FCIRX_L_BCIRX-1,4:7))*t/Itv]; %左手上到下弧形
