function r= Draw_7DOF_compare_point(P_R,RotationM_R,PathPoint_R,P_L,RotationM_L,PathPoint_L,Vn_u_f,V_rf_l4,Vn_rfl4_nuf,Vproj_end_rfl4_nuf,Vn_nuf_rotx5_along_NRfl4NufVn_nuf_rotx5_along_NRfl4Nuf,Vn_WstToEnd_WstToProjEndRfl4Nuf,V_n_yrot12,V_x_rot1to6)
...
plot3([P_L(10,1),P_L(10,1)+Vn_u_f(1)],[P_L(10,2),P_L(10,2)+Vn_u_f(2)],[P_L(10,3),P_L(10,3)+Vn_u_f(3)],'--b','MarkerSize',2,'Linewidth',1);

%%==畫Z
V_shz=[0;0;1];
V_shz=V_shz*300;
plot3([P_L(10,1),P_L(10,1)+V_shz(1)],[P_L(10,2),P_L(10,2)+V_shz(2)],[P_L(10,3),P_L(10,3)+V_shz(3)],'--r','MarkerSize',2,'Linewidth',2);

V_x_rot1to6=V_x_rot1to6*200;
plot3([P_L(5,1),P_L(5,1)+V_x_rot1to6(1)],[P_L(5,2),P_L(5,2)+V_x_rot1to6(2)],[P_L(5,3),P_L(5,3)+V_x_rot1to6(3)],'--g','MarkerSize',2,'Linewidth',2);text(P_L(5,1)+V_x_rot1to6(1),P_L(5,2)+V_x_rot1to6(2),P_L(5,3)+V_x_rot1to6(3),'Vx_rot1to6');


%%==畫Vn_nuf_rotx6_along_NRfl4Nuf
%Vn_nuf_rotx5_along_NRfl4NufVn_nuf_rotx5_along_NRfl4Nuf=Vn_nuf_rotx5_along_NRfl4NufVn_nuf_rotx5_along_NRfl4Nuf*100/norm(Vn_nuf_rotx5_along_NRfl4NufVn_nuf_rotx5_along_NRfl4Nuf);
%plot3([P_L(7,1),P_L(7,1)+Vn_nuf_rotx5_along_NRfl4NufVn_nuf_rotx5_along_NRfl4Nuf(1)],[P_L(7,2),P_L(7,2)+Vn_nuf_rotx5_along_NRfl4NufVn_nuf_rotx5_along_NRfl4Nuf(2)],[P_L(7,3),P_L(7,3)+Vn_nuf_rotx5_along_NRfl4NufVn_nuf_rotx5_along_NRfl4Nuf(3)],'--m','MarkerSize',2,'Linewidth',1);
...
plot3([P_L(7,1),P_L(7,1)+Vn_WstToEnd_WstToProjEndRfl4Nuf(1)],[P_L(7,2),P_L(7,2)+Vn_WstToEnd_WstToProjEndRfl4Nuf(2)],[P_L(7,3),P_L(7,3)+Vn_WstToEnd_WstToProjEndRfl4Nuf(3)],'--g','MarkerSize',2,'Linewidth',1);text(P_L(7,1)+Vn_WstToEnd_WstToProjEndRfl4Nuf(1),P_L(7,2)+Vn_WstToEnd_WstToProjEndRfl4Nuf(2),P_L(7,3)+Vn_WstToEnd_WstToProjEndRfl4Nuf(3),'Vnlllll');
