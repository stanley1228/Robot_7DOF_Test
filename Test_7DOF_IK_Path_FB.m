...
for t=1:1:DEF_DESCRETE_POINT
    ...
    %inverse kinematic
    theta = IK_7DOF_FB( L0,L1,L2,L3,L4,L5,x_base,y_base,z_base,in_x_end,in_y_end,in_z_end,in_alpha,in_beta,in_gamma,Rednt_alpha);
...
%     end
    ...
    %forward kinematic
    [out_x_end,out_y_end,out_z_end,out_alpha,out_beta,out_gamma,P,RotationM] = FK_7DOF_FB(L0,L1,L2,L3,L4,L5,x_base,y_base,z_base,theta);

    %記錄路徑上的點
    PathPoint(t,1:3)=[out_x_end out_y_end out_z_end];
    
    %畫關節點圖
    Draw_7DOF_FB_point(P,RotationM,PathPoint);
